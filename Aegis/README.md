...
Plugin de ejemplo para Minecraft 1.20.1 que integra un sistema completo de economía, trabajos, misiones y una tienda interactiva. Incluye comandos `/eco`, `/jobs`, `/missions` y `/shop`.
